      ...
      <div className="relative flex h-full min-h-[320px] overflow-hidden rounded-3xl bg-slate-950 text-white shadow-2xl">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="relative h-56 w-56">
                  ...
                  >
                    <div
                      className={cn(
                        ...
                        isActive
                          ? "scale-110 border-white/70 bg-white text-emerald-600 shadow-lg"
                          : "text-white/80",
                      )}
            ...
            <div className="absolute inset-[28%] rounded-full bg-white/10 backdrop-blur-sm flex items-center justify-center text-[15px] font-semibold text-emerald-200">
              {content.loopLabel}
            </div>
          </div>
        </div>
            ...
            <div className="flex items-start gap-3 text-left">
              <div
                ...
                style={{
                  background:
                    activeStep.gradient ||
                    `linear-gradient(135deg, ${activeStep.accent}, ${activeStep.accent})`,
                }}
              >
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <TypographyText
                          ...
                          className="text-sm"
                          style={
                            isActive ? { color: `${step.accent}cc` } : undefined
                          }
                        >
                          {step.description}
                        </TypographyText>
